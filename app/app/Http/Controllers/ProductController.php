...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            'perc_icms_interestadual', 'perc_icms_interno', 'perc_fcp_interestadual', 'pICMSST', 'modBC', 'modBCST', 'pCredSN'];
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            $business_id = $request->session()->get('user.business_id');
            $product_details = $request->only(['name', 'brand_id', 'unit_id', 'category_id', 'tax', 'barcode_type', 
                ...
                'perc_fcp_interestadual', 'pICMSST', 'modBC', 'modBCST', 'pCredSN'
            ]);
    ...
    public function getProducts()
    {
        if (request()->ajax()) {
            ...
            foreach($result as $r){
                ...
                $r->selling_price = number_format($r->selling_price, $business->casas_decimais_valor, ',', '');
