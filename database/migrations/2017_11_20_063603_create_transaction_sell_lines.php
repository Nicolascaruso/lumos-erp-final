...
class CreateTransactionSellLines extends Migration
{
    ...
    public function up()
    {
        Schema::create('transaction_sell_lines', function (Blueprint $table) {
            ...
            $table->string('n_pedido', 30)->nullable();
            $table->string('n_item', 30)->nullable();

            // alter table transaction_sell_lines add column n_pedido varchar(30) default null;
            // alter table transaction_sell_lines add column n_item varchar(30) default null;
