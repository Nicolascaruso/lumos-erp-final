<div class="modal-dialog modal-xl" role="document">
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="form-group">
            ...
            <input class="form-control featured-field warning-input" required placeholder="CPF/CNPJ" data-mask="00.000.000/0000-00" name="cpf_cnpj" type="text" id="cpf_cnpj">
          </div>
        </div>
        ...
        <div class="col-md-2">
          <div class="form-group">
            ...
            <div class="input-group" style="width: 100%;">
              ...
              {!! Form::select('uf', $estados, '', ['id' => 'uf2', 'class' => 'form-control select2 featured-field warning-input']); !!}
        ...
        <div class="col-md-2 ">
          <div class="form-group">
            ...
            <input class="form-control warning-input featured-field" required placeholder="CEP" name="cep" data-mask="00000-000" type="text" id="cep">
          </div>
        </div>
  ...
  <script type="text/javascript">
    ...
    function buscaDados(){
      ...
      ({
        ...
        url: '{{ route("nfe.consultaCadastro")}}',
      ...
      $.ajax({
        ...
        { 
          ...
          if(data.status == "ERROR"){
            ...
            $('#rua_entrega').val(data.logradouro)
            $('#numero').val(data.numero)
            $('#numero_entrega').val(data.numero)
            $('#bairro').val(data.bairro)
            $('#bairro_entrega').val(data.bairro)
            let cep = data.cep;
            $('#cep').val(cep.replace(".", ""))
            $('#cep_entrega').val(cep.replace(".", ""))
            findCidade(data.municipio, (res) => {
  ...
  /**
    ...
    */
    ...
    $('#ie_rg').blur((event) => {
      if($('#ie_rg').val().length > 6){
        $('#contribuinte').val('1').change()
      }else{
        $('#contribuinte').val('0').change()
      }
    });
