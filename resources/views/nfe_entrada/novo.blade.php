@extends('layouts.app')
@section('title', 'Gerar NFe de Entrada')
...
<section class="content">
	...
	<h2 class="box-title">Emitir NFe Entrada</h2>
				...
				<div class="row">
					<div class="col-sm-12">
						...
						<div class="col-md-3">
							...
							<a style="width: 100%;" class="btn btn-lg btn-success" id="send-sefaz">Transmitir NFe Entrada</a>
						</div>
		...
		<script type="text/javascript">
			...
			$('#send-sefaz').click(() => {
				...
				if(!tipo_pagamento){
					...
					$.post('{{ route("nfe-entrada.transmitir") }}', {
						...
						swal("sucesso", "NFe emitida, recibo: " + e, "success")
						.then(() => {
					...
					// 		tipo_pagamento: tipo_pagamento
					// 	},
					// 	url: '{{ route("nfe-entrada.transmitir") }}',
					// 	dataType: 'json',
					// 	success: function(e){
					// 		console.log(e)
